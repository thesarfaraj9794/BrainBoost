...
class _LessonContentPageState extends State<LessonContentPage> {
  ...
  Future<void> loadLessonContents() async {
    try {
      // JSON load using helper
      await JsonHelper.loadLessonContent();
      final data = JsonHelper.getLesson(
          widget.className, widget.subject, widget.lesson);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor:   const Color.fromARGB(255, 231, 179, 195).withOpacity(0.25),
        appBar: AppBar(
          title: Text(
